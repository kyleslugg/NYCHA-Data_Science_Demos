...
AND (a.failurecode in ('DEBRISSPILL', 'GRAFFITIPRB', 'HOPPER', 'REGULATEDWASTE')
OR a.problemcode in ('DEBRIS','GARBAGE','GLASSONGROUND','GRAFFITI','NEEDSCLEANING','NEEDSGRAFFITIREMOVAL','NORMCLEANUP','PHASGRAFFITI','RAGS','SLIPPERYWET','SPILL','TRASHRECEPTICLEWWP','TRIPHAZARD'))  
AND a.Zzcreate_Month_Id >= '202101'
